...
let ComplaintsController = class ComplaintsController {
    ...
    updateStatus(id, body) {
        return this.complaintsService.updateStatus(id, body.status, body.comment, body.rejectionReason, body.rejectedBy);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ComplaintsController.prototype, "getAdminAnalytics", null);
