...
let ChatService = ChatService_1 = class ChatService {
    ...
    getAnswer(question, lang = 'English') {
        ...
        if (['otp not', 'receive an otp', 'receive a otp', 'otp varunnilla', 'ഒടിപി', 'otp വരുന്നില്ല'].some(w => q.includes(w))) {
            return lang === 'Malayalam'
        ...
        if ((isFilingAction) || q.includes('grievance') || hasMalayalamComplaint) {
            return lang === 'Malayalam'
